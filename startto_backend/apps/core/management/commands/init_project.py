...
# App
from startto_backend.apps.core.models import Location, SubscriptionGroup
from startto_backend.apps.core.management.commands._locations import LOCATIONS
from startto_backend.apps.core.management.commands._subscription_groups import SUBSCRIPTION_GROUPS
